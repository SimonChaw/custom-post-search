...
class CPS_Settings {
    ...
    */
    ...
    public function setup() {
        $postarr = ['post_title' => 'SETTINGS', 'post_type' => 'CPS_SETTINGS', 'post_content' => '', ];
    ...
    public function loadExistingSettings($front_end = false) {
        ...
        foreach ($metas as $meta) {
            if (substr($meta->meta_key, 0, 1) !== "_" && strpos($meta->meta_key, 'cps') !== 0) {
                ...
                $meta_array = array('searchable' => empty($searchable) ? false : $searchable, 'friendly_label' => empty($friendly_label) ? "" : $friendly_label, 'key' => $meta->meta_key,);
